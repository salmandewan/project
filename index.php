	...
	<div id="canvas">
		<div id="box_wrapper">
									...
									<div class="col-xs-12">
										<div class="slide_description_wrapper">
											<div class="slide_description">
												...
												<div class="intro-layer to_animate" data-animation="fadeInUp">
													<p> <span class="hero-text">2k<i>20</i></span> </p>
												</div>
												<div class="intro-layer to_animate" data-animation="fadeInUp">
													<p> <span class="small-text big-spacing">Summer Collection</span> </p>
												</div>
												<div class="intro-layer to_animate" data-animation="fadeInUp">
													<div class="slide_buttons"> <a href="#" class="theme_button min_width_button">go to shop</a> </div>
												</div>
											</div>
			...
			<section id="about" class="ls section_padding_top_150 section_padding_bottom_150">
				...
				<div style="text-align:center;" class="contact-form-submit"> <button type="submit" id="contact_form_submit" name="contact_submit" class="theme_button min_width_button margin_0"><a href="gallery-regular-3-cols.php">View Product Details</a></button> </div>
								</div>
			</section>
			...
			<section id="section-social" class="ls with_top_border columns_margin_0"><br><br>
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
